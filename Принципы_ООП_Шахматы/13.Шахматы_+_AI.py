# coding: utf-8
# Стас Волик. Шахматы. 13.Шахматы + AI

# Программа работает с частью доски. Ходы возможны для таких шахматных фигур, как 'Пешка', 'Король' и 'Ладья'.
...
class Chessboard(object):
    ...
    def fill(self):
        ...
        board[0][3] = ChessmanKing(black)
        board[6][1] = ChessmanPawn(white)
        board[7][3] = ChessmanKing(white)
